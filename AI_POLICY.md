...
### Adopted from [ghostty](https://github.com/ghostty-org/ghostty/blob/main/AI_POLICY.md)

The Rad Gyms project has strict rules for AI usage:
...
- **Issues can use AI assistance but must have a full
...
These rules apply only to outside contributions to Rad Gyms. Maintainers
...
Please remember that Rad Gyms is maintained by humans.

Every issue, and pull request is read and reviewed by
humans (and very rarely, machines, too). It is a boundary point at which
