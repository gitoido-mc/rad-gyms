...
class EnUSLocaleProvider(
    ...
    private fun infoTranslations(): Map<String, String> =
        mapOf(
    ...
    private fun errorTranslations(): Map<String, String> =
        mapOf(
    ...
    private fun objectTranslations(): Map<String, String> =
        mapOf(
    ...
    private fun guiTranslations(): Map<String, String> =
        mapOf(
    ...
    private fun statTranslations(): Map<String, String> =
        mapOf(
