...
object MRadGymsCodec {
    ...
    @JvmStatic
    val ENTITY_COORDS_YAW: Codec<EntityCoordsAndYaw> =
        RecordCodecBuilder.create {
            it
                .group(
    ...
    @JvmStatic
    val THRESHOLD: Codec<TeamLevelThreshold> =
        RecordCodecBuilder.create {
            it
                .group(
    ...
    @JvmStatic
    val AI_CONFIG: Codec<BattleAIConfig> =
        RecordCodecBuilder.create {
            it
                .group(
    ...
    @JvmStatic
    val BATTLE_RULES: Codec<BattleRules> =
        RecordCodecBuilder.create {
            it
                .group(
    ...
    val GYM_REWARD: Codec<RewardInterface> =
        GYM_REWARD_TYPE.dispatch(
            "type",
    ...
    @JvmStatic
    val CACHE_POOL: UnboundedMapCodec<String, Map<String, Int>> =
        Codec.unboundedMap(
            Codec.STRING,
